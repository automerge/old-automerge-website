...
// Afterwards, update the hash again to allow link sharing.
...
// updateText() calculates and applies a minimum edit between two strings
changeDoc((doc) =>
  updateText(
...
This is as simple as adding `BrowserWebSocketClientAdapter` to your Repo's network subsystem. We'll do this at creation time, but remember you can add and remove adapters later, too.
...
//...
// highlight-next-line
import { BrowserWebSocketClientAdapter } from "@automerge/react";
