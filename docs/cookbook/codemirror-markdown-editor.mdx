...
Now if we go to `localhost:5173` we'll see the Automerge demo page which `create-repo-app` has generated. If you look in `src/main.rs` you'll see that the example application:
